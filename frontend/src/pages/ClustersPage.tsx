    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">Gérer les clusters connectés</p>
        </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
        {isLoading ? (
          ...
          <div className="py-16 text-center text-sm text-slate-500">Aucun cluster</div>
        ) : (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {activeCluster === c.name && <Badge variant="info">actif</Badge>}
                  </div>
                  {!c.is_local && (
