...
|-------|-----------|-----------|
| GitHub Actions | [references/github-actions.md](https://github.com/jeffallan/claude-skills/blob/main/skills/devops-engineer/references/github-actions.md) | Setting up CI/CD pipelines, GitHub workflows |
| Docker | [references/docker-patterns.md](https://github.com/jeffallan/claude-skills/blob/main/skills/devops-engineer/references/docker-patterns.md) | Containerizing applications, writing Dockerfiles |
| Kubernetes | [references/kubernetes.md](https://github.com/jeffallan/claude-skills/blob/main/skills/devops-engineer/references/kubernetes.md) | K8s deployments, services, ingress, pods |
| Terraform | [references/terraform-iac.md](https://github.com/jeffallan/claude-skills/blob/main/skills/devops-engineer/references/terraform-iac.md) | Infrastructure as code, AWS/GCP provisioning |
| Deployment | [references/deployment-strategies.md](https://github.com/jeffallan/claude-skills/blob/main/skills/devops-engineer/references/deployment-strategies.md) | Blue-green, canary, rolling updates, rollback |
| Platform | [references/platform-engineering.md](https://github.com/jeffallan/claude-skills/blob/main/skills/devops-engineer/references/platform-engineering.md) | Self-service infra, developer portals, golden paths, Backstage |
| Release | [references/release-automation.md](https://github.com/jeffallan/claude-skills/blob/main/skills/devops-engineer/references/release-automation.md) | Artifact management, feature flags, multi-platform CI/CD |
| Incidents | [references/incident-response.md](https://github.com/jeffallan/claude-skills/blob/main/skills/devops-engineer/references/incident-response.md) | Production outages, on-call, MTTR, postmortems, runbooks |
